...
parser.add_argument('--train_dataset', '-tr', default='H:/learnkeras/data/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/JPEGImages', type=str)
parser.add_argument('--target_dataset', '-ta', default='H:/learnkeras/data/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/SegmentationClass', type=str)
parser.add_argument('--txtfile', '-t', default='train.txt', type=str)
...
if len(args.weight):
    train_model.load_weights(args.weight)
